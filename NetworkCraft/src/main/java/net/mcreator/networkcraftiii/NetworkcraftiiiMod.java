 ...
 *
 */
package net.mcreator.networkcraftiii;
...
@Mod("networkcraftiii")
public class NetworkcraftiiiMod {
	public static final Logger LOGGER = LogManager.getLogger(NetworkcraftiiiMod.class);
	public static final String MODID = "networkcraftiii";
